...
public class SlideMenuAttribute extends BaseSlideMenuActivity implements
    ...
    public void onContentChanged() {
        ...
        mPrimaryShadowWidthLabel = findViewById(R.id.primaryShadowWidthLabel);
        mPrimaryShadowWidth = findViewById(R.id.primaryShadowWidth);
        mSecondaryShadowWidthLabel = findViewById(R.id.secondaryShadowWidthLabel);
        mSecondaryShadowWidth = findViewById(R.id.secondaryShadowWidth);
        mSlideMode = findViewById(R.id.slideMode);
        mSlideLeft = findViewById(R.id.slideLeft);
        mSlideRight = findViewById(R.id.slideRight);
        mInterpolator = findViewById(R.id.interpolator);
        mEdgeSlide = findViewById(R.id.edgeSlide);
        mEdgeSlideWidthLabel = findViewById(R.id.edgeSlideWidthLabel);
        mEdgeSlideWidth = findViewById(R.id.edgeSlideWidth);
